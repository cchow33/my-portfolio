    ...
    <section id="skills" class="py-20">
      <div class="xl:max-w-7xl xl:mx-auto max-w-full pl-[8%] pr-[5%] pt-[8%]">
        ...
        <div class="grid grid-cols-4 gap-5 pt-[8%] sm:pl-[10%]">
          ...
          <span>
            <DiReact size={60} /> React
          </span>
          <span>
            <SiRedux size={60} /> Redux
          </span>
          <span>
          ...
          <span>
            <SiJquery size={60} /> jQuery
          </span>
          <span>
            <BsBootstrap size={60} /> Bootstrap
          </span>
          <span>
          ...
          <span>
            <SiTailwindcss size={60} /> Tailwind CSS
          </span>
          <span>
            <SiMongodb size={60} /> MongoDB
          </span>
          <span>
            <SiExpress size={60} /> Express
          </span>
          <span>
            <DiGit size={60} /> Git/Github
          </span>
        </div>
      </div>
    </section>
