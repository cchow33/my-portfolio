...
const Main = () => {
  ...
  return (
    ...
    <div class = 'grid h-[80%] place-items-center'>
      <h1 class='text-[120px] font-display sm:text-[67px] xl:text-[100px]'>Carmen Chow</h1>
      <h2 class='text-[80px] font-display sm:text-[45px] pb-[60px] mt-[0px] xl:text-[64px]'>I/m a <span class='underline text-[#e9756b]'>Front-end Developer</span> building and designing web-based user interfaces.</h2>
