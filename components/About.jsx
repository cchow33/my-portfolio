  ...
  return (
    <section id="about">
      <div class="xl:max-w-7xl xl:mx-auto max-w-full pl-[8%] pr-[5%] pt-[8%]">
        ...
        <p class="pt-[20px] text-[30px] font-poppins sm:text-[22px] px-[10px] xl:text-[30px]">
          ...
          self-improvement. readable, modular, scalable code
        </p>
        ...
        <div>
          ...
          <ul>
            <li class="font-poppins text-[20px] mt-[20px] xl:text-[26px]">
              {/* <li class="font-display text-[20px] mt-[20px] xl:text-[26px]"> */}
              🏃 training for a 10K
            </li>
            <li class="font-poppins text-[20px] xl:text-[26px]">
