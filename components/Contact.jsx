...
{/* <section id="contact" class = 'bg-[#fcf2f1] grid h-screen place-items-center'> */}
    ...
    <p class="font-display text-[30px] leading-loose">Have a question? Want to hire me, work together or just want to say hello? <br></br>Email me at <span class="underline">reach.cchow@gmail.com</span> and let's chat!</p>
