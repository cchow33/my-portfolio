...
{/* <section id="contact" class = 'bg-[#fcf2f1] grid h-screen place-items-center'> */}
    ...
    <h1 class="decoration-purple-300 decoration-4 text-[60px] mb-[20px] sm:text-[40px] sm:mt-[20px]"><span class='text-[40px] mr-[5px]'> ✉️ </span> Contact</h1>
    <p class="font-display text-[30px] leading-loose sm:text-[22px]">Have a question? <br></br> Want to hire me, work together or just want to say hello? <br></br>Email me at <span class="underline">reach.cchow@gmail.com</span> and let's chat!</p>
