  ...
  return (
    ...
    >
      <div class="xl:max-w-7xl xl:mx-auto max-w-full pl-[8%] pr-[5%] py-[10%]">
        ...
        <p class="font-display text-[30px] leading-loose sm:text-[22px] xl:text-[30px]">
          Have a question? <br></br> Want to hire me, work together or just want
          to say hello? <br></br>Email me at{" "}
          <span class="underline">reach.cchow@gmail.com</span> and let/s chat!
        </p>
        ...
        <span class="flex">
          <a
            ...
            class="relative inline-block py-5 pr-4 font-medium group m-[10px] "
          >
            <BsGithub size={40} />
          </a>
