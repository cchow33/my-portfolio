...
const Projects = () => {
  ...
  return (
    ...
    <section id="projects" class='xl:max-w-7xl xl:mx-auto max-w-full pl-[5%] pr-[5%] pt-[10%]'>
...
<div class="bg-gray-100 rounded-[20px] p-[40px] m-[40px]"> 
    ...
    <div class="flex flex-row justify-end">
      ...
      <Image src="/../public/assets/portfolio-project.png" alt="project5" width="500" height="500"/>
